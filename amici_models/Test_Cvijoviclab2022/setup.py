...
def get_extension() -> Extension:
    ...
    sources = [os.path.join("swig", "Test_Cvijoviclab2022.i"), *get_model_sources()]
    ...
    # Build shared object
    ext = Extension(
        'Test_Cvijoviclab2022._Test_Cvijoviclab2022',
        sources=sources,
        include_dirs=ext_include_dirs,
        libraries=libraries,
        library_dirs=ext_library_dirs,
        swig_opts=[
            '-c++', '-modern', '-outdir', 'Test_Cvijoviclab2022',
...
# Install
setup(
    name='Test_Cvijoviclab2022',
    cmdclass=CMDCLASS,
    version='0.1.0',
    description='AMICI-generated module for model Test_Cvijoviclab2022',
