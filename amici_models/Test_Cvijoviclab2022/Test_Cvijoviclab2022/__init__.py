"""AMICI-generated module for model Test_Cvijoviclab2022"""
...
if '0.11.32' != amici.__version__:
    raise amici.AmiciVersionError(
        f'Cannot use model `Test_Cvijoviclab2022` in {Path(__file__).parent}, '
...
from Test_Cvijoviclab2022._Test_Cvijoviclab2022 import *
