...
/*-----------------------------------------------
              @(target):= _Test_Cvijoviclab2022.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__Test_Cvijoviclab2022

#else
#  define SWIG_init    init_Test_Cvijoviclab2022

#endif
#define SWIG_name    "_Test_Cvijoviclab2022"
