...
extern void Jy_Test_Cvijoviclab2022simple(realtype *Jy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydsigma_Test_Cvijoviclab2022simple(realtype *dJydsigma, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_Test_Cvijoviclab2022simple(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_colptrs_Test_Cvijoviclab2022simple(SUNMatrixWrapper &colptrs, int index);
extern void dJydy_rowvals_Test_Cvijoviclab2022simple(SUNMatrixWrapper &rowvals, int index);

extern void dwdp_Test_Cvijoviclab2022simple(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp);
extern void dwdp_colptrs_Test_Cvijoviclab2022simple(SUNMatrixWrapper &colptrs);
extern void dwdp_rowvals_Test_Cvijoviclab2022simple(SUNMatrixWrapper &rowvals);
extern void dwdx_Test_Cvijoviclab2022simple(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl);
extern void dwdx_colptrs_Test_Cvijoviclab2022simple(SUNMatrixWrapper &colptrs);
extern void dwdx_rowvals_Test_Cvijoviclab2022simple(SUNMatrixWrapper &rowvals);



extern void dxdotdw_Test_Cvijoviclab2022simple(realtype *dxdotdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void dxdotdw_colptrs_Test_Cvijoviclab2022simple(SUNMatrixWrapper &colptrs);
extern void dxdotdw_rowvals_Test_Cvijoviclab2022simple(SUNMatrixWrapper &rowvals);
...
extern void dydx_Test_Cvijoviclab2022simple(realtype *dydx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx);

extern void sigmay_Test_Cvijoviclab2022simple(realtype *sigmay, const realtype t, const realtype *p, const realtype *k, const realtype *y);
extern void dsigmaydp_Test_Cvijoviclab2022simple(realtype *dsigmaydp, const realtype t, const realtype *p, const realtype *k, const realtype *y, const int ip);

extern void w_Test_Cvijoviclab2022simple(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *tcl);
extern void x0_Test_Cvijoviclab2022simple(realtype *x0, const realtype t, const realtype *p, const realtype *k);



extern void xdot_Test_Cvijoviclab2022simple(realtype *xdot, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void y_Test_Cvijoviclab2022simple(realtype *y, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);




extern void x_solver_Test_Cvijoviclab2022simple(realtype *x_solver, const realtype *x_rdata);
 ...
 */
class Model_Test_Cvijoviclab2022simple : public amici::Model_ODE {
  public:
    /**
     * @brief Default constructor.
     */
    Model_Test_Cvijoviclab2022simple()
        : amici::Model_ODE(
              ...
              amici::SimulationParameters(
                  ...
                  std::vector<realtype>{5.0, 3.0, 0.0, 0.0}        // dynamic parameters
              ),
    ...
    amici::Model *clone() const override {
        return new Model_Test_Cvijoviclab2022simple(*this);
    }
    ...
    void fJy(realtype *Jy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        Jy_Test_Cvijoviclab2022simple(Jy, iy, p, k, y, sigmay, my);
    }
    ...
    void fdJydsigma(realtype *dJydsigma, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        dJydsigma_Test_Cvijoviclab2022simple(dJydsigma, iy, p, k, y, sigmay, my);
    }
    ...
    void fdsigmaydp(realtype *dsigmaydp, const realtype t, const realtype *p, const realtype *k, const realtype *y, const int ip) override {
        dsigmaydp_Test_Cvijoviclab2022simple(dsigmaydp, t, p, k, y, ip);
    }
    ...
    void fdJydy(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        dJydy_Test_Cvijoviclab2022simple(dJydy, iy, p, k, y, sigmay, my);
    }

    void fdJydy_colptrs(SUNMatrixWrapper &colptrs, int index) override {        dJydy_colptrs_Test_Cvijoviclab2022simple(colptrs, index);
    }

    void fdJydy_rowvals(SUNMatrixWrapper &rowvals, int index) override {        dJydy_rowvals_Test_Cvijoviclab2022simple(rowvals, index);
    }
    ...
    void fdwdp(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp) override {
        dwdp_Test_Cvijoviclab2022simple(dwdp, t, x, p, k, h, w, tcl, dtcldp);
    }

    void fdwdp_colptrs(SUNMatrixWrapper &colptrs) override {        dwdp_colptrs_Test_Cvijoviclab2022simple(colptrs);
    }

    void fdwdp_rowvals(SUNMatrixWrapper &rowvals) override {        dwdp_rowvals_Test_Cvijoviclab2022simple(rowvals);
    }
    ...
    void fdwdx(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl) override {
        dwdx_Test_Cvijoviclab2022simple(dwdx, t, x, p, k, h, w, tcl);
    }

    void fdwdx_colptrs(SUNMatrixWrapper &colptrs) override {        dwdx_colptrs_Test_Cvijoviclab2022simple(colptrs);
    }

    void fdwdx_rowvals(SUNMatrixWrapper &rowvals) override {        dwdx_rowvals_Test_Cvijoviclab2022simple(rowvals);
    }
    ...
    void fdxdotdw(realtype *dxdotdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        dxdotdw_Test_Cvijoviclab2022simple(dxdotdw, t, x, p, k, h, w);
    }

    void fdxdotdw_colptrs(SUNMatrixWrapper &colptrs) override {        dxdotdw_colptrs_Test_Cvijoviclab2022simple(colptrs);
    }

    void fdxdotdw_rowvals(SUNMatrixWrapper &rowvals) override {        dxdotdw_rowvals_Test_Cvijoviclab2022simple(rowvals);
    }
    ...
    void fdydx(realtype *dydx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx) override {
        dydx_Test_Cvijoviclab2022simple(dydx, t, x, p, k, h, w, dwdx);
    }
    ...
    void fsigmay(realtype *sigmay, const realtype t, const realtype *p, const realtype *k, const realtype *y) override {
        sigmay_Test_Cvijoviclab2022simple(sigmay, t, p, k, y);
    }
    ...
    void fw(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *tcl) override {
        w_Test_Cvijoviclab2022simple(w, t, x, p, k, h, tcl);
    }


    void fx0(realtype *x0, const realtype t, const realtype *p, const realtype *k) override {
        x0_Test_Cvijoviclab2022simple(x0, t, p, k);
    }
    ...
    void fxdot(realtype *xdot, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        xdot_Test_Cvijoviclab2022simple(xdot, t, x, p, k, h, w);
    }
    ...
    void fy(realtype *y, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        y_Test_Cvijoviclab2022simple(y, t, x, p, k, h, w);
    }
    ...
    void fx_solver(realtype *x_solver, const realtype *x_rdata) override {
        x_solver_Test_Cvijoviclab2022simple(x_solver, x_rdata);
    }
    ...
    std::string getName() const override {
        return "Test_Cvijoviclab2022simple";
    }
