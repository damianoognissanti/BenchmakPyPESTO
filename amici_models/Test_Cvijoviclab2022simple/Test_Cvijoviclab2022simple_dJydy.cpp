...
#include "Test_Cvijoviclab2022simple_dJydy.h"

namespace amici {
namespace model_Test_Cvijoviclab2022simple {

void dJydy_Test_Cvijoviclab2022simple(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my){
    switch(iy) {
        case 0:
