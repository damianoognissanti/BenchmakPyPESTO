...
def get_extension() -> Extension:
    ...
    sources = [os.path.join("swig", "Test_Cvijoviclab2022simple.i"), *get_model_sources()]
    ...
    # Build shared object
    ext = Extension(
        'Test_Cvijoviclab2022simple._Test_Cvijoviclab2022simple',
        sources=sources,
        include_dirs=ext_include_dirs,
        libraries=libraries,
        library_dirs=ext_library_dirs,
        swig_opts=[
            '-c++', '-modern', '-outdir', 'Test_Cvijoviclab2022simple',
...
# Install
setup(
    name='Test_Cvijoviclab2022simple',
    cmdclass=CMDCLASS,
    version='0.1.0',
    description='AMICI-generated module for model Test_Cvijoviclab2022simple',
    ...
    install_requires=['amici==0.11.32'],
